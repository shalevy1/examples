...
var container = new PIXI.projection.Container2s();
container.position.set(app.screen.width / 2, app.screen.height / 2);
container.proj.surface = new PIXI.projection.StrangeSurface();
...
bunny.scale.set(0.7);
bunny.pluginName = 'sprite_strange';
container.addChild(bunny);

//illuminate the sprite from two points!
var lightY = new PIXI.projection.Sprite2s(PIXI.Texture.WHITE);
lightY.anchor.set(0.5, 0.5);
lightY.scale.set(15, 30);
lightY.alpha = 0.2;
lightY.pluginName = 'sprite_strange';
container.addChildAt(lightY, 0);

var lightX = new PIXI.projection.Sprite2s(PIXI.Texture.WHITE);
lightX.anchor.set(0.5, 0.5);
lightX.scale.set(30, 15);
lightX.alpha = 0.2;
lightX.pluginName = 'sprite_strange';
...
app.ticker.add(function (delta) {
    ...
    var posX = container.toLocal(squareX.position);
    var posY = container.toLocal(squareY.position);
    container.proj.surface.setAxisX(posX, squareX.factor, container.transform);
    container.proj.surface.setAxisY(posY, squareY.factor, container.transform);
});
