...
PIXI.loader
    ...
    .load(function(loader, resources) {
        containerSprite.removeChild(bunny);
        bunny = new PIXI.projection.Spine2d(resources.spineboy.spineData);
        bunny.state.setAnimation(0, 'walk', true);
        bunny.pivot.set(0, -150);
        bunny.scale.set(2);
        containerSprite.addChild(bunny);
    });
